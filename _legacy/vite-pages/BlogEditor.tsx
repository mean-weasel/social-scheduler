...
export function BlogEditor() {
  ...
  }, [id, isEditing, getDraft, initialized, fetchDrafts, navigate])
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      if (isEditing) {
        ...
        navigate(`/blog/edit/${newDraft.id}`, { replace: true })
      }
    } catch (error) {
  ...
  }, [title, content, date, notes, scheduledAt, isEditing, id, addDraft, updateDraft, navigate])
  ...
  }, [isEditing, id, archiveDraft, navigate])
  ...
  }, [isEditing, id, deleteDraft, navigate])
